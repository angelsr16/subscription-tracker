    ...
    <div>
      ...
      >
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  {[
                    ...
                    <option value={method} key={method} className="bg-black">
                      {method.toUpperCase()}
                    </option>
                  ))}
                </select>
            ...
            <input
              ...
              {...register("startDate", {
                ...
                validate: (value) => {
                  ...
                  const now = new Date();
                  if (selected > now) return "You cannot select a future date";
                  return true;
                },
              })}
            />
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="px-4 py-2 bg-zinc-900 hover:bg-zinc-950 text-white rounded-md cursor-pointer disabled:opacity-60"
